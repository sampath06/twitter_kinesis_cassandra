...
public final class KinesisConsumer {
    ...
    private static final String DEFAULT_APP_NAME = "TwitterStreamingApp";
    private static final String DEFAULT_STREAM_NAME = "streaming_poc";
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length > 1) {
            System.err.println("Usage: java " + KinesisConsumer.class.getName() + " <propertiesFile>");
            System.exit(1);
